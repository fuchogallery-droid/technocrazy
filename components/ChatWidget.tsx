...
const FAQS = [
  ...
  { q: "galeriax", keywords: ["galeriax", "galería", "galeria", "contenido exclusivo", "suscripción", "suscripcion"], answer: "GaleríaX es una plataforma de contenido exclusivo por suscripción con 3 niveles de acceso y pagos con Stripe y PayPal. Visítala en: https://galeriax.vercel.app" },
