...
const PRODUCTS: Product[] = [
  {
    ...
    features: [
      ...
      "Seguridad de 4 capas: SSH + token + red privada + Tailscale",
      "Sin instalar apps — funciona como PWA en cualquier navegador",
      "Avisarte cuando esté disponible para el público",
    ],
    gallery: ["/product-img-3.png", "/product-img-1.png", "/product-img-2.png"],
    price: "Próximamente",
    buyUrl: "https://wa.me/17794318214?text=Hola%20Rafael!%20Quiero%20que%20me%20avises%20cuando%20lance%20Claude%20Remote%20%F0%9F%9A%80",
    tag: "PWA · App Móvil",
    color: "#E8751A",
    soon: true,
  },
